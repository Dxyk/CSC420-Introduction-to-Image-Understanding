...
\begin{document}
	...
	\begin{homeworkProblem}
		\begin{enumerate}
			\item 
			\noindent \textit{Given an $n×n$ image $I$, and $m×m$ filter $h$, what is the computational cost of computing $h ∗ I$ if $h$ is not separable?}
			...
			\item 
			\noindent \textit{What is the computational cost if h is separable?}
	...
	\begin{homeworkProblem}
		...
		%				\includegraphics[width=.35\linewidth]{images/1.jpg}
		%				\caption{caption}
		%				\label{fig:1}
		%			\end{subfigure}
		%		
