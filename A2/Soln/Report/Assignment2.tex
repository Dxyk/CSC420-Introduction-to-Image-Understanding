...
\begin{document}
    ...
    \begin{homeworkProblem}
        ...
        \begin{enumerate}
            ...
            \begin{figure}[!htb]
                \includegraphics[width=0.75\linewidth]{images/question_4/4_2_connected.png}
                \centering
                \caption{}
                \label{fig:4.2.3}
            \end{figure}
            ...
            \begin{figure}[!htb]
                \includegraphics[width=0.75\linewidth]{images/question_4/4_2_match_vs_threshold_L2.png}
                \centering
                \caption{}
                \label{fig:4.2.4}
            \end{figure}
            ...
            \begin{figure}[!htb]
                \begin{subfigure}{.45\textwidth}
                    \includegraphics[width=\linewidth]{images/question_4/4_3_marked_sample_1_L1.jpg}
                    \centering
                    \caption{Sample1 feature points}
                    \label{fig:4.3.1.1}
                \end{subfigure}
                \begin{subfigure}{.45\textwidth}
                    \includegraphics[width=\linewidth]{images/question_4/4_3_marked_sample_2_L1.jpg}
                    \centering
                    \caption{Sample2 feature points}
                    \label{fig:4.3.1.2}
                \end{subfigure}
            ...
            \begin{figure}[!htb]
                \begin{subfigure}{.45\textwidth}
                    \includegraphics[width=\linewidth]{images/question_4/4_3_marked_sample_1_L3.jpg}
                    \centering
                    \caption{Sample1 feature points}
                    \label{fig:4.3.2.1}
                \end{subfigure}
                \begin{subfigure}{.45\textwidth}
                    \includegraphics[width=\linewidth]{images/question_4/4_3_marked_sample_2_L3.jpg}
                    \centering
                    \caption{Sample2 feature points}
                    \label{fig:4.3.2.2}
                \end{subfigure}
            ...
            \item 
            The idea is to find the dominant color channel of reference img and test img, then perform SIFT between these 2 dominant color channel. In this way we take the color of img into account cause we only perform computation with dominant color channel.
            Drawing the line with green color.
        \end{enumerate}
